...
import 'package:freelance_clone_app/Widgets/comments_widget.dart';
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  void getJobData() async {
    ...
    if (jobDatabase == null) {
      ...
      setState(() {
        ...
        recruiment = jobDatabase.get('recruiment');
  ...
  //     path: emailCompany,
  //     query:
  //         'subject=Applying for $jobTitle&body=Greetings, kindly provide a CV file',
  //   );
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color.fromARGB(255, 127, 162, 130), Colors.brown],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            isDeadlineAvailable
                                ? 'Hiring actively, send your CV or resume:'
                                : 'Deadline has passed-',
                            style: TextStyle(
                              color: isDeadlineAvailable
                                  ? Color.fromARGB(255, 219, 221, 75)
                                  : Colors.red,
                              fontWeight: FontWeight.normal,
                              fontSize: 16,
                            ),
                        ...
                        Center(
                          child: MaterialButton(
                            ...
                            color: Color.fromARGB(255, 127, 198, 220),
                            elevation: 0,
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      icon: const Icon(
                                        Icons.add_comment,
                                        color:
                                            Color.fromARGB(255, 127, 198, 220),
                                        size: 30,
                                      ),
                                    ),
                                    const SizedBox(
